	...
	$('.product_add').on('click', function() {
		if ($('.pr_article').attr('data-sel') != 1) {
			...
			$.ajax({
				...
				dataType: "html",
				data: ({
					name: $('.pr_name').attr('data-val'), article: $('.pr_article').attr('data-val'),
					barcode: $('.pr_barcode').attr('data-val'), catalog: $('.pr_catalog').attr('data-val'),
					quantity: $('.pr_quantity').attr('data-val'), price: $('.pr_price').attr('data-val'), 
					purchase_price: $('.pr_purchase_price').attr('data-val'), discount_price: $('.pr_discount_price').attr('data-val'),
					img: $('.pr_img').attr('data-val'), brand: $('.pr_brand').attr('data-val'),
					color: $('.pr_color').attr('data-val'), size: $('.pr_size').attr('data-val'),
